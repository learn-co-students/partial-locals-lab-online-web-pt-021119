...
RSpec.describe 'classroom_show_view' do
  ...
  let(:student) { Student.create(name: 'Bobby', hometown: Faker::Address.city, birthday: Faker::Date.birthday) }

  before do
    5.times do
      Student.create(name: Faker::Name.name, hometown: Faker::Address.city, birthday: Faker::Date.birthday)
    end
  ...
  it 'renders classroom information on the show view' do
    ...
    student = Student.create(name: 'Bobby', hometown: Faker::Address.city, birthday: Faker::Date.birthday)
